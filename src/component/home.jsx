              ...
              <div className="row">
                <div className="col-md-4 card_decor">
                  <div className="feature-box">
                    <img src="/src/images/softwaredev.jpg" className="serviceimage" alt="Software Development" />
                ...
                <div className="col-md-4 card_decor">
                  <div className="feature-box">
                    <img src="/src/images/clouddev.jpg" alt="Cloud Integration" className="serviceimage" />
                ...
                {testimonials.map((testimonial, index) => (
                  <div className="col-md-4" key={testimonial._id}>
                    ...
                    >
                      ...
                      <img
                        src={testimonial.image || "/src/images/default.png"}
